...
module.exports = (opts = {}) => {
		// 	token, privateJwk, alg_1 = 'RSA-OAEP-256', issuerPublicJwk, alg_2 = 'ES256'
		const { token, privateJwk, alg_1 = 'RSA-OAEP-256', issuerPublicJwk, alg_2 = 'ES256', isRevoked, key = 'user'} = opts;
